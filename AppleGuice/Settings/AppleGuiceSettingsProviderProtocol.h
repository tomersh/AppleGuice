...
typedef enum AppleGuiceMethodInjectionPolicy {
    AppleGuiceMethodInjectionPolicyManual = 0,
    AppleGuiceMethodInjectionPolicyAutomatic = 1
} AppleGuiceMethodInjectionPolicy;
